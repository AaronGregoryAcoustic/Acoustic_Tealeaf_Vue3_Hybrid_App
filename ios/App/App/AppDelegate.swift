...
class AppDelegate: UIResponder, UIApplicationDelegate {
	...
	// Override point for customization after application launch.
		...
		let postMessageURL: String = "https://tealeaf-op-pca.sandbox.acoustic-demo.com/TealeafTarget.php"


		// Enable Connect framework with app key and post message URL
		connectApplicationHelperObj.enableFramework(appKey, withPostMessageUrl: postMessageURL)

		// Enable Tealeaf framework with settings from ConnectBasicConfig.plist
